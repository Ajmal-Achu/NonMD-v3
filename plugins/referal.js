...
let handler = async (m, { conn, usedPrefix, text }) => {
  ...
  if (text) {
    if ('ref_count' in users[m.sender]) throw 'Can not use the referral code!'
...
`.trim()
    m.reply(`
Get ${xp_link_creator} XP for every new user using your referral code
${users[m.sender].ref_count} people have used your referral code

Your referral code: ${code}

Share a link to friends: ${command_link}
